...
public class FileUtils {
	...
	public List<PlannerFileEntity> parseFileInfo(MultipartHttpServletRequest request) throws Exception {
		...
		List<PlannerFileEntity> fileInfoList = new ArrayList<>();
		...
		while (fileTagNames.hasNext()) {
			...
			for (MultipartFile file : files) {
				...
				// 파일 정보를 리스트에 저장
				PlannerFileEntity entity = new PlannerFileEntity();
...
public List<PlannerFileEntity> parseFileInfo(MultipartFile[] files) throws Exception {
